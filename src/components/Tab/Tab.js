...
const georgia = dayOneInfo[0]

function TabComponent() {
    console.log(georgia.image)
        return (
            ...
            <TabPanel>
                <Tabs forceRenderTabPanel>
                    <TabList className='text-white fs-300 ff-sans-cond uppercase letter-spacing-5 t-list'>
                        <Tab className='tabs'>{georgia.location}</Tab>
                        {/* <Tab className='tabs'>{dayOne[1].location}</Tab> */}
                        {/* <Tab className='tabs'>{dayOne[2].location}</Tab>          */}
                    </TabList>
                    <TabPanel>
                        <DayInfo key={georgia.id}  alt={georgia.stop} src={georgia.image} description={georgia.description} stop={georgia.stop}/>
                    </TabPanel>
